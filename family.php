...
<div class="text-center container-fluid" style="margin-top: 20px;margin-bottom:20px;">
    <h1 class="display-3" >
      ...
      ;">Your</span>
       <Span class="text-success" style="font-size: 70px;font-weight: bold;text-transform: uppercase;">Family Event</Span> 
    </h1>
...
<div class="" style="padding:60px">
    ...
    <img style="filter: brightness(30%);border-radius: 8px;"  src="image/1.jpg" class="card-img" alt="Wedding.jpg">
    <div class="card-img-overlay" style="padding:80px">
        <h5 class="card-title text-white hedding" style="">Wedding</h5>
        <p class="card-text">We Can Organize You Wedding. All Types Of Sevices We Provide For Your Wedding Like A "Waiters take orders and serve food and beverages to patrons at tables in dining esthblishment.","Dercoration","We sreve food and drink as per your choice.",etc. </p>
        <p class="card-text">Booking <span style="">Your</span>
       <Span class="text-success" style="">Wedding</Span> Date Now</p>
...
<div class="" style="padding:60px">
    <div class="card bg-dark text-white border-0" style="">
        <img style="filter: brightness(30%);border-radius: 8px;"  src="image/2.jpg" class="card-img" alt="Wedding.jpg">
        <div class="card-img-overlay" style="padding:80px">
            <h5 class="card-title text-white hedding" style="">Engagement</h5>
...
<div class="" style="padding:60px">
    <div class="card bg-dark text-white border-0" style="">
        <img style="filter: brightness(30%);border-radius: 8px;"  src="image/3.jpg" class="card-img" alt="Wedding.jpg">
        <div class="card-img-overlay" style="padding:80px">
            <h5 class="card-title text-white hedding" style="">Birthday</h5>
